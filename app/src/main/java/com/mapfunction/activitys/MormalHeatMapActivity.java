 ...
 */
public class MormalHeatMapActivity extends Activity implements
...
//        mapView.setCoodSystem(MapOptions.COOD_SYSTEM_4326);
        init();
        map.setGridUrlListener(new MapController.GridUrlListener() {
            @Override
...
//        map.setGridUrlListener(new MapController.a() {
//            @Override
...
//        });
    ...
    public  final float[] ALT_HEATMAP_GRADIENT_START_POINTS = { 0.0f,
