...
import com.leador.api.maps.MapController.InfoWindowAdapter;
import com.leador.api.maps.MapController.OnInfoWindowClickListener;
import com.leador.api.maps.MapController.OnMapClickListener;
import com.leador.api.maps.MapController.OnMarkerClickListener;
...
import com.leador.api.services.poisearch.PoiSearch.OnPoiSearchListener;
...
import com.leador.api.services.route.RouteSearch.OnRouteSearchListener;
...
import com.mapfunction.copycode.LMapUtil;
import com.mapfunction.copycode.OffLineMapUtils;
...
//		mapView.setCoodSystem(MapOptions.COOD_SYSTEM_4326);
		...
		init();
		lMap.setGridUrlListener(new MapController.GridUrlListener() {
			@Override
		...
		lMap.setOnCameraChangeListener(new MapController.OnCameraChangeListener() {
			@Override
	...
	public void onInfoWindowClick(Marker marker) {
		...
		if (marker.equals(startMk)) {
            ...
            com.leador.api.services.core.LatLonPoint mapLatlon = LMapUtil.convertToLatLonPoint(startMk.getPosition());
            ...
            com.leador.api.services.core.LatLonPoint mapLatlon = LMapUtil.convertToLatLonPoint(targetMk.getPosition());
